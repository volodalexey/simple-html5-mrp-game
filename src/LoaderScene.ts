import { Container, Graphics, Assets, type ResolverManifest, type Spritesheet } from 'pixi.js'
  ...
  bundles: [
    {
      ...
      assets: {
        ...
        level1Settings: 'assets/levels/Level-1-settings.json'
      }
    },
    {
      name: 'level-2-bundle',
      assets: {
        ...
        level2Settings: 'assets/levels/Level-2-settings.json'
      }
    },
    {
      name: 'level-3-bundle',
